...
const Footer = () => {
  return (
    <div  className=' flex items-start w-full h-screen bg-zinc-900 p-20 overflow-'>
      ...
      <div className="w-1/2 h-full  flex flex-col justify-between items-start  font-['Neue_Montreal'] ">
        ...
        <div className="logo">
          <svg width="72" height="27" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="w-1/2 flex flex-col justify-between items-start font-['Neue_Montreal'] ">
        ...
        <div className="links w-full flex flex-col mt-10 gap-4">
